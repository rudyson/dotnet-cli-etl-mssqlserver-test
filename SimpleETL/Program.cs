...
public static class Program
{
    ...
    private static void StartExecution(IConfiguration configuration)
    {
        ...
        stopwatch.Start();
        using var csvReader = new CsvReaderService(csvReaderOptions);

        var csvDataEnumerable = csvReader.ReadCsv();
        Console.WriteLine($"[{nameof(CsvReaderService)}::Elapsed] {stopwatch.Elapsed.TotalMilliseconds} ms");
        ...
        var numberOfRowsInserted = databaseService.InsertData(csvDataEnumerable);
